...
// Draw rotating cube, black if shadow is true, colored otherwise.
void drawRotatingCube(int shadow) {
    static float rotateInc = 0.0;

    glPushMatrix();

        glTranslatef(0.0, 8.0, 0.0);
        glRotatef(30, 1, 0, 0);
        glRotatef(rotateInc, 0, 1, 0);
...
void printInteraction(void)
{
   ...
   cout << "Press the up/down arrow keys to speed up/slow down animation." << endl;
}
